...
/**
 * Binds {@code iqkv.platform.*} from {@code application.yml}.
 *
 * <p>Platform-wide settings must be consistent across all core services
 * (IAM, Billing, CMS, etc.) — they all read the same {@code ROLLOUT_MODE}
