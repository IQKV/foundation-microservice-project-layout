...
This directory contains documentation for the Spring Boot application template.
...
| 3   | [03-architecture-overview.md](03-architecture-overview.md) | Layered architecture, actuator build info, extensibility                  |
| 4   | [04-development-workflow.md](04-development-workflow.md)   | Git workflow, pre-commit hooks, CI workflows, and release process         |
| 5   | [05-testing-guide.md](05-testing-guide.md)                 | Test categories, JaCoCo thresholds, ArchUnit rules                        |
